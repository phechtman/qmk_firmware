...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_preonic_1x2uC( \
    ...
    TT(_NUMPAD), KC_LCTL, KC_LGUI, KC_LALT, LOWER,       KC_SPC,       RAISE,   KC_RALT, KC_RGUI, KC_APP, KC_RCTL  \
  ),
  ...
  * |------+------+------+------+------+------+------+------+------+------+------+------|
  * | Ctrl | Ctrl| GUI  | Alt  |Lower |    Space    |Raise |  Alt | Right  | Down | Left |
  * `-----------------------------------------------------------------------------------'
  */
  [_GAME] = LAYOUT_preonic_1x2uC( \
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, LOWER,       KC_SPC,       RAISE,   KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT  \
  ),
  ...
  * |------+------+------+------+------+-------------+------+------+------+------+------|
  * | Caps |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|Game|Insert|
  * |------+------+------+------+------+------|------+------+------+------+------+------|
  ...
  */
  [_ADJUST] = LAYOUT_preonic_1x2uC( \
    ...
    KC_CAPS, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  GAME,  KC_INS,  \
