...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT_preonic_grid( \
    ...
    KC_LCTL, TT(_NUMPAD), KC_LGUI, KC_LALT, LOWER, KC_ENT, KC_SPC,   RAISE,    RALT_T(KC_LEFT), RGUI_T(KC_DOWN), KC_UP, RCTL_T(KC_RIGHT)  \
  ),
...
[_WORKMAN] = LAYOUT_preonic_1x2uC( \
  ...
  */
  [_LOWER] = LAYOUT_preonic_1x2uC( \
    ...
    KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, JS_FUN, _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_BSLS, \
  ...
  */
  [_RAISE] = LAYOUT_preonic_1x2uC( \
    ...
    KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, JS_FUN, _______, _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PIPE, \
